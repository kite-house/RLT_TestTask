...
class TestAgrigation(unittest.TestCase):
    def testHour(self):
        ...
        # ВЫХОДНЫЕ ДАННЫЕ
        str({"dataset": [8177, 8407, 4868, 7706, 8353, 7143, 6062, 11800, 4077, 8820, 4788, 11045, 13048, 2729, 4038, 9888,
    ...
    def testDay(self):
        ...
        # ВЫХОДНЫЕ ДАННЫЕ
        str({"dataset": [0, 0, 0, 195028, 190610, 193448, 203057, 208605, 191361, 186224, 181561, 195264, 213854, 194070,
    ...
    def testMonth(self):
        ...
        # ВЫХОДНЫЕ ДАННЫЕ
        str({"dataset": [5906586, 5515874, 5889803, 6092634],
            "labels": ["2022-09-01T00:00:00", "2022-10-01T00:00:00", "2022-11-01T00:00:00", "2022-12-01T00:00:00"]}).replace("'", '"'))
